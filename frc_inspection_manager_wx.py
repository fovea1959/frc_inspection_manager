...
class MainFrame ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		# Grid
		self.inspection_grid.CreateGrid( 1, 9 )
		...
		self.no_inspections = wx.StaticText( self.inspection_history, wx.ID_ANY, u"No inspections.", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.no_inspections.Wrap( -1 )

		bSizer8.Add( self.no_inspections, 0, wx.ALIGN_TOP, 5 )
